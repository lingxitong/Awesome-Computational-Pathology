...
- **HoVer-Net** — simultaneous nuclear instance segmentation and classification in multi-tissue histology. [![Paper](https://img.shields.io/badge/Paper-MedIA-b31b1b.svg)](https://www.sciencedirect.com/science/article/pii/S1361841519301045) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/vqdang/hover_net)
- **PanNuke** — pan-cancer nuclei instance segmentation and classification dataset. [![Paper](https://img.shields.io/badge/Paper-ECCV%20Workshop-b31b1b.svg)](https://arxiv.org/abs/2003.10778) [![Dataset](https://img.shields.io/badge/Dataset-Website-blue.svg)](https://jgamper.github.io/PanNukeDataset/)
- **MoNuSeg** — multi-organ nucleus segmentation benchmark for histopathology images. [![Paper](https://img.shields.io/badge/Paper-TMI-b31b1b.svg)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10439521/) [![Dataset](https://img.shields.io/badge/Dataset-Grand%20Challenge-blue.svg)](https://monuseg.grand-challenge.org/)
- **MoNuSAC** — multi-organ nuclei segmentation and classification challenge. [![Paper](https://img.shields.io/badge/Paper-TMI-b31b1b.svg)](https://ieeexplore.ieee.org/document/9446924) [![Dataset](https://img.shields.io/badge/Dataset-Grand%20Challenge-blue.svg)](https://monusac-2020.grand-challenge.org/)
- **Lizard** — large-scale colonic nuclear instance segmentation and classification dataset. [![Paper](https://img.shields.io/badge/Paper-ICCV%20Workshop-b31b1b.svg)](https://arxiv.org/abs/2108.11195) [![Dataset](https://img.shields.io/badge/Dataset-Warwick-blue.svg)](https://warwick.ac.uk/fac/cross_fac/tia/data/lizard/)
- **CoNIC** — nuclear segmentation and classification challenge based on colon tissue images. [![Paper](https://img.shields.io/badge/Paper-MedIA-b31b1b.svg)](https://www.sciencedirect.com/science/article/pii/S1361841523003079) [![Dataset](https://img.shields.io/badge/Dataset-Grand%20Challenge-blue.svg)](https://conic-challenge.grand-challenge.org/)
- **NuCLS** — crowdsourced dataset for nucleus classification, localization, and segmentation. [![Paper](https://img.shields.io/badge/Paper-GigaScience-b31b1b.svg)](https://academic.oup.com/gigascience/article/doi/10.1093/gigascience/giac037/6586817) [![Dataset](https://img.shields.io/badge/Dataset-Website-blue.svg)](https://sites.google.com/view/nucls/home)
- **CellViT** — vision transformer for precise nuclei instance segmentation in pathology. [![Paper](https://img.shields.io/badge/Paper-MedIA-b31b1b.svg)](https://www.sciencedirect.com/science/article/pii/S1361841524000689) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/TIO-IKIM/CellViT)
- **CellViT++** — WSI-scale cell segmentation, classification, and visualization framework. [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/TIO-IKIM/CellViT-plus-plus)
- **DeepLIIF** — cell segmentation, stain separation, and single-cell IHC quantification. [![Paper](https://img.shields.io/badge/Paper-Nature%20Machine%20Intelligence-1f77b4.svg)](https://www.nature.com/articles/s42256-022-00536-4) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/nadeemlab/DeepLIIF)
- **Mesmer** — whole-cell and nuclear segmentation for highly multiplexed tissue images. [![Paper](https://img.shields.io/badge/Paper-Nature%20Biotechnology-1f77b4.svg)](https://www.nature.com/articles/s41587-021-01094-0) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/vanvalenlab/deepcell-tf)
- **Cellpose** — generalist cellular segmentation model widely used in microscopy and pathology. [![Paper](https://img.shields.io/badge/Paper-Nature%20Methods-1f77b4.svg)](https://www.nature.com/articles/s41592-020-01018-x) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/MouseLand/cellpose)
- **CellProfiler** — classical open-source platform for quantitative cell image analysis. [![Paper](https://img.shields.io/badge/Paper-Nature%20Methods-1f77b4.svg)](https://www.nature.com/articles/nmeth.2083) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/CellProfiler/CellProfiler)
- **SIPaKMeD** — public Pap smear dataset for cervical cell classification. [![Paper](https://img.shields.io/badge/Paper-ICIP-b31b1b.svg)](https://www.cse.uoi.gr/~cnikou/Publications/C072%20-%20Plissiti%20-%20icip%202018%20-%20Athens.pdf) [![Dataset](https://img.shields.io/badge/Dataset-Kaggle-blue.svg)](https://www.kaggle.com/datasets/marinaeplissiti/sipakmed)
- **DeepPap** — deep learning for cervical cytology cell classification. [![Paper](https://img.shields.io/badge/Paper-JBHI-b31b1b.svg)](https://arxiv.org/abs/1801.08616)
- **AIATBS** — hybrid AI-assisted TBS classification for cervical liquid-based thin-layer smears. [![Paper](https://img.shields.io/badge/Paper-Nature%20Communications-1f77b4.svg)](https://www.nature.com/articles/s41467-021-23913-3)
- **Cervical WSI Screening** — robust whole-slide cervical cytopathology screening with deep learning. [![Paper](https://img.shields.io/badge/Paper-Nature%20Communications-1f77b4.svg)](https://www.nature.com/articles/s41467-021-25296-x)
- **Task-Decomposed Cell Detection** — task-decomposing and cell-comparing method for cervical lesion cell detection. [![Paper](https://img.shields.io/badge/Paper-TMI-b31b1b.svg)](https://ieeexplore.ieee.org/document/9754224)
- **Patch-to-Sample Reasoning** — patch-level to sample-level reasoning for cervical WSI cancer screening. [![Paper](https://img.shields.io/badge/Paper-IEEE%20TAI-b31b1b.svg)](https://www.computer.org/csdl/journal/ai/2024/06/10285382/1Rd2FdKWJHO)
- **Detection-Free Cervical WSI Screening** — weakly supervised detection-free pipeline for cervical cancer screening. [![Paper](https://img.shields.io/badge/Paper-MICCAI-b31b1b.svg)](https://dl.acm.org/doi/10.1007/978-3-031-43987-2_24)
- **AICCS** — AI cervical cytology screening system for grading cervical lesions and cancer. [![Paper](https://img.shields.io/badge/Paper-Nature%20Communications-1f77b4.svg)](https://www.nature.com/articles/s41467-024-48705-3)
- **LBC-DL** — liquid-based cytology model for cervical precancer and cancer detection. [![Paper](https://img.shields.io/badge/Paper-Nature%20Communications-1f77b4.svg)](https://www.nature.com/articles/s41467-025-58883-3)
- **Compact-Microscope Cytology AI** — AI-assisted cervical cytology screening for resource-limited settings. [![Paper](https://img.shields.io/badge/Paper-Nature%20Communications-1f77b4.svg)](https://www.nature.com/articles/s41467-025-62589-x)
- **Cervical TCT Dataset** — large annotated ThinPrep cytologic test dataset for cervical cytology AI. [![Paper](https://img.shields.io/badge/Paper-Scientific%20Data-1f77b4.svg)](https://www.nature.com/articles/s41597-025-04374-5)
- **ThinPrep Pap Dataset** — cross-validated ThinPrep Pap cervical cytology dataset for AI training. [![Paper](https://img.shields.io/badge/Paper-Scientific%20Data-1f77b4.svg)](https://www.nature.com/articles/s41597-024-04328-3)
- **UniCAS** — foundation model for cervical cytology screening with large-scale WSI pretraining. [![Paper](https://img.shields.io/badge/Paper-Cell%20Reports%20Medicine-1f77b4.svg)](https://www.cell.com/cell-reports-medicine/fulltext/S2666-3791%2825%2900643-3)
