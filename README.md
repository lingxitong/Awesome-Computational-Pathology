...
<sub><em>Representative datasets and evaluation benchmarks for WSI classification, nuclei analysis, multimodal pathology, and foundation model assessment.</em></sub>
