...
- **HE2RNA** — weakly supervised prediction of bulk RNA-seq expression from whole-slide images. [![Paper](https://img.shields.io/badge/Paper-Nature%20Communications-1f77b4.svg)](https://www.nature.com/articles/s41467-020-17678-4) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/owkin/HE2RNA_code)
...
- **ST-Net** — integrating histology with spatial transcriptomics to infer spatial gene expression patterns. [![Paper](https://img.shields.io/badge/Paper-Nature%20BME-1f77b4.svg)](https://www.nature.com/articles/s41551-020-0578-x) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/bryanhe/ST-Net)
- **iSCALE** — scaling up spatial transcriptomics for large-sized tissues via super-resolution reconstruction. [![Paper](https://img.shields.io/badge/Paper-Nature%20Methods-1f77b4.svg)](https://www.nature.com/articles/s41592-025-02770-8) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/amesch441/iSCALE)
- **OmiCLIP / Loki** — visual–omics foundation model bridging histopathology with spatial transcriptomics via contrastive learning. [![Paper](https://img.shields.io/badge/Paper-Nature%20Methods-1f77b4.svg)](https://www.nature.com/articles/s41592-025-02707-1) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/GuangyuWangLab2021/Loki)
- **SpaGCN** — spatial domain discovery by integrating gene expression, spatial coordinates, and histology. [![Paper](https://img.shields.io/badge/Paper-Nature%20Methods-1f77b4.svg)](https://www.nature.com/articles/s41592-021-01255-8) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/jianhuupenn/SpaGCN)
...
- **XFuse** — super-resolved spatial transcriptomics by fusing histology and gene expression. [![Paper](https://img.shields.io/badge/Paper-Nature%20Biotechnology-1f77b4.svg)](https://doi.org/10.1038/s41587-021-01075-3) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/ludvb/xfuse)
- **DeepSpot** — leveraging spatial context for enhanced spatial transcriptomics prediction from H&E images. [![Paper](https://img.shields.io/badge/Paper-medRxiv-b31b1b.svg)](https://www.medrxiv.org/content/10.1101/2025.02.09.25321567v2) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/ratschlab/DeepSpot)
...
- **DeepSpaCE** — efficient prediction of spatial transcriptomics profiles from tissue images. [![Paper](https://img.shields.io/badge/Paper-Sci%20Rep-b31b1b.svg)](https://doi.org/10.1038/s41598-022-07685-4) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/tmonjo/DeepSpaCE)
- **SpaCell** — integrating tissue morphology and spatial gene expression to predict disease cells. [![Paper](https://img.shields.io/badge/Paper-Bioinformatics-b31b1b.svg)](https://academic.oup.com/bioinformatics/article/36/7/2293/5663455) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/BiomedicalMachineLearning/SpaCell)
- **STimage** — robust and interpretable prediction of gene markers and cell types from H&E images. [![Paper](https://img.shields.io/badge/Paper-Nature%20Communications-1f77b4.svg)](https://doi.org/10.1038/s41467-026-68487-0) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/BiomedicalMachineLearning/STimage)
- **HisToGene** — super-resolution spatial gene expression prediction from histology with spatial priors. [![Paper](https://img.shields.io/badge/Paper-bioRxiv-b31b1b.svg)](https://www.biorxiv.org/content/10.1101/2021.11.28.470212) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/maxpmx/HisToGene)
- **HEX** — AI-enabled virtual spatial proteomics from histopathology and multimodal integration for survival outcome prediction. [![Paper](https://img.shields.io/badge/Paper-Nature%20Medicine-1f77b4.svg)](https://www.nature.com/articles/s41591-025-04060-4) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/lilab-stanford/HEX)
...
- **HE2Gene** — image-to-RNA translation for spatial transcriptomics via multi-task learning. [![Paper](https://img.shields.io/badge/Paper-Bioinformatics-b31b1b.svg)](https://academic.oup.com/bioinformatics/article/40/6/btae343/7688334) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/Microbiods/HE2Gene)
- **HGGEP** — gene expression prediction from histology via hypergraph neural networks. [![Paper](https://img.shields.io/badge/Paper-Briefings%20in%20Bioinformatics-b31b1b.svg)](https://academic.oup.com/bib/article/25/6/bbae500/7821151) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/QSong-github/HGGEP)
- **M2OST** — many-to-one regression Transformer for accommodating the hierarchical pyramidal structure of WSIs. [![Paper](https://img.shields.io/badge/Paper-AAAI%202025-b31b1b.svg)](https://ojs.aaai.org/index.php/AAAI/article/view/32830/34985) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/dootmaan/m2ost)
- **FmH2ST** — foundation model-based spatial transcriptomics generation using dual-branch knowledge integration. [![Paper](https://img.shields.io/badge/Paper-NAR-b31b1b.svg)](https://academic.oup.com/nar/article/53/17/gkaf865/8249850) [![Code](https://img.shields.io/badge/Code-Website-green.svg)](https://www.sdu-idea.cn/codes.php?name=FmH2ST)
...
- **PORPOISE** — pan-cancer multimodal fusion of histology and molecular profiles for prognosis prediction. [![Paper](https://img.shields.io/badge/Paper-Cancer%20Cell-b31b1b.svg)](https://doi.org/10.1016/j.ccell.2022.07.004) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/mahmoodlab/PORPOISE)
...
- **MOTCat** — multimodal optimal transport-based co-attention transformer with global structure consistency for survival prediction. [![Paper](https://img.shields.io/badge/Paper-ICCV%202023-b31b1b.svg)](https://openaccess.thecvf.com/content/ICCV2023/papers/Xu_Multimodal_Optimal_Transport-based_Co-Attention_Transformer_with_Global_Structure_Consistency_for_ICCV_2023_paper.pdf) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/Innse/MOTCat)
- **MurreNet** — modeling holistic multimodal interactions between histopathology and genomic profiles for survival prediction. [![Paper](https://img.shields.io/badge/Paper-MICCAI%202025-b31b1b.svg)](https://papers.miccai.org/miccai-2025/paper/0057_paper.pdf)
- **HypergraphLearning_with_Cross-Modality_Rebalance** — multimodal cancer survival analysis via hypergraph learning with cross-modality rebalance. [![Paper](https://img.shields.io/badge/Paper-IJCAI%202025-b31b1b.svg)](https://www.ijcai.org/proceedings/2025/0201.pdf) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/MCPathology/MRePath)
- **Cancer-Type-Aware_Framework** — robust multimodal survival prediction under missing modalities. [![Paper](https://img.shields.io/badge/Paper-Briefings%20in%20Bioinformatics-b31b1b.svg)](https://academic.oup.com/bib/article/27/2/bbag124/8537492)
...
- **InSTaPath** — integrating spatial transcriptomics and histopathology images via multimodal topic learning. [![Paper](https://img.shields.io/badge/Paper-bioRxiv-b31b1b.svg)](https://www.biorxiv.org/content/10.64898/2026.03.16.712067v1) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/xwymary/InSTaPath)
